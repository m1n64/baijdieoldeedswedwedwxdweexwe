...
import {
	...
	Search,
	Spinner,
	Cell, SplitLayout, SplitCol, withAdaptivity, usePlatform, VKCOM
} from '@vkontakte/vkui';
...
import Translate from "./panels/Translate";
					...
					<Panel>
						...
						<Group>
							...
							<Cell
								...
								data-story="services"
								onClick={onStoryChange}
								before={<Icon24MessageReplyOutline />}
							>
								С фени
							</Cell>
						</Group>
			...
			>
				...
				<Tabbar>
					...
					<TabbarItem
						...
						data-story="services"
						text="С фени"
					><Icon24MessageReplyOutline/></TabbarItem>
				</Tabbar>
				}>
					<View id="feed" activePanel="feed">
						<Panel id="feed">
							<PanelHeader left={<PanelHeaderBack />}>Перевод на феню</PanelHeader>
							<Translate
								activeState={"feed"}
							/>
						</Panel>
					...
					<View id="services" activePanel="services">
						<Panel id="services">
							<PanelHeader left={<PanelHeaderBack />}>Перевод с фени</PanelHeader>
							<Translate
